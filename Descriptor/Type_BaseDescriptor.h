...
typedef struct Desc{
  void * element;
  struct Desc * next;
} *BaseDesc; // DescriptorBase is represented by a list of generic Descriptors, and is a pointer to the first element of the list
...
} *ListBaseDesc; //ListBaseDesc is an ordered chained list of file-descriptor structure 
